...
const ratingSx = {
  color: brand.teal,
  "& .MuiRating-iconEmpty": { color: "rgba(131,60,159,0.28)" },
};
      ...
      {reviews.map((r, i) => (
        <Box key={r.id}>
          ...
          <Stack direction="row" spacing={1.25} sx={{ alignItems: "flex-start" }}>
            <Avatar sx={{ width: 38, height: 38, bgcolor: "rgba(131,60,159,0.18)", color: brand.tealBright, fontWeight: 800, fontSize: "0.95rem" }}>
